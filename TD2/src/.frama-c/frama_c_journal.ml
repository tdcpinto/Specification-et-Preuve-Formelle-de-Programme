(* Frama-C journal generated at 14:22 the 13/01/2026 *)
...
let run () =
  Dynamic.Parameter.String.set ""
    "/home/leop/Desktop/Work/Teaching/Specification-et-Preuve-Formelle-de-Programme-Private/public/TD2/src/example.c";
  ...
  Project.clear
    ~selection:(State_selection.of_list
                  [ State.get "Report.print_once";
                    ...
                    State.get "Consolidation graph" ])
    ();
  !Db.RteGen.annotate_kf (Globals.Functions.find_by_name "div");
  Project.clear
    ~selection:(State_selection.of_list
                  [ State.get "Report.print_once";
                    State.get "Report.print_csv_once";
